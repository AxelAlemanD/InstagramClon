                    ...
                    <div class="container">
                        <div class="row" style="padding-top: 30px;">
                            ...
                            <div class="col-7">
                                ...
                                <div class="row">
                                    <div class="col-4">
                                        <p class="profile-datas"><strong>{{$totalPublications}}</strong> publicaciones</p>
                                    </div>
                                    <div class="col-4">
                                        <p class="profile-datas"><strong>{{$totalFollowers}}</strong> seguidores</p>
                                    </div>
                                    <div class="col-4">
                                        <p class="profile-datas"><strong>{{$totalFollowings}}</strong> siguiendo</p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                        ...
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            <div class="row" style="padding-bottom: 25px;">
                                ...
                                @else
                                    <div class="col-12">
                                        <div>
                                            <h3>No haz realizado ninguna publicación</h3>
                                        </div>
                                    </div>
                                @endif
                            </div>
